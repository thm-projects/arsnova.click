...
export function createSlider(index) {
	const questionItem = QuestionGroupCollection.findOne().questionList[EventManagerCollection.findOne().questionIndex];
	const plainSlider = document.getElementById('rangeSlider');
